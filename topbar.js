...
// It self-injects a top bar (quick links) and a bottom tab bar,
// and applies a few mobile-safety CSS rules (zoom lock, modal
// scroll lock, etc.) shared across every page.
// =============================================================
(function () {
  'use strict';
